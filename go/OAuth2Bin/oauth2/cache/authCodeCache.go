...
// The refresh token is kept intach and can be used for future requests.
...
// the SHA-256 hash of the concatenate of time of creation and the same nonce as above.
