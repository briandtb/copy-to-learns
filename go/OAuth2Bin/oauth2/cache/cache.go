...
// CloseConn closes a Redis connections.
...
func init() {
	pool = redis.Pool{
		...
		Dial: func() (redis.Conn, error) {
			...
			} else if os.Getenv("REDIS_PORT") == "" && os.Getenv("REDIS_PASS") == "" && os.Getenv("REDIS_PORT") == "" {
...
// Prints out the Redis Server source. Dial maybe called multiple times
